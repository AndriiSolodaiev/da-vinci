    ...
    resources: {
      ...
      uk: {
        ...
        translation: {
          ...
          must_be_positive: 'Введіть додатнє число',
          field_must_be_number: 'Поле повинно містити лише числа',
          invalid_age_range: 'Вік має бути в межах від {{min}} до {{max}} років',
      ...
      en: {
        ...
        translation: {
          ...
          sending: 'Sanding',
          email: 'E-mail',
          field_must_be_number: 'This field must contain only numbers',
          must_be_positive: 'Please enter a positive number',
          invalid_age_range: 'Age must be between {{min}} and {{max}} years',
